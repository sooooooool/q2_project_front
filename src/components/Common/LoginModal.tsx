...
const LoginModal: React.FC<LoginModalProps> = ({ visible, onClose }) => {
  ...
  const handleKakaoLogin = () => {
    window.location.href = `${process.env.REACT_APP_BACKEND_URL}/auth/kakao/callback`; // 백엔드 카카오 로그인 경로로 리다이렉트
  };

  // 네이버 로그인 API 호출 함수
  const handleNaverLogin = () => {
    window.location.href = `${process.env.REACT_APP_BACKEND_URL}/auth/naver/callback`; // 백엔드 네이버 로그인 경로로 리다이렉트
  };
    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={handleNaverLogin} // 네이버 로그인 클릭 시 API 호출
        >
        ...
        <button
          ...
          onClick={handleKakaoLogin} // 카카오 로그인 클릭 시 API 호출
        >
